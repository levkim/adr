...
export const LOCATIONS: Record<string, LocationDef> = {
  ...
  'baekdu-cheonji': {
    ...
    // 사용자 지정 좌표(백두산 천지, 북·중 국경 칼데라). DEM 검증: 시작 2741m → 도착 2195m,
    // 전 구간 하강(상승 0/24), 평균 ~30°. 낙차 546m, 수평 0.93km. 외륜→천지 호수면.
    bbox: { west: 128.058, south: 41.98, east: 128.095, north: 42.02 },
    start: { lat: 41.993344, lon: 128.077369 }, // 41°59'36.04"N 128°04'38.53"E
    finish: { lat: 41.995975, lon: 128.066678 }, // 41°59'45.51"N 128°04'00.04"E
    zoom: 13,
    treeline: 2000, // 창바이산 수목한계선 — 런 전 구간 알파인 툰드라
    country: '북한·중국 · 백두산 천지',
    summit: 2741,
    vertical: 546,
    desc: '백두산 칼데라 외륜에서 천지 호수면으로 내리꽂는 알파인 라인. 2741m에서 546m 강하.',
  },
  'lotte-arai': {
    id: 'lotte-arai',
    name: '롯데 아라이 리조트',
