...
export const LOCATIONS: Record<string, LocationDef> = {
  ...
  'lotte-arai': {
    ...
    // 사용자 지정 좌표(롯데 아라이, 일본 니가타 묘코). DEM 검증: 시작 1278m → 도착 969m,
    // 전 구간 하강(상승 0/24), 평균 ~19°. 낙차 309m, 수평 0.9km.
    bbox: { west: 138.12, south: 36.978, east: 138.163, north: 37.006 },
    start: { lat: 36.992872, lon: 138.138856 }, // 36°59'34.34"N 138°08'19.88"E
    ...
    summit: 1278,
    vertical: 309,
    desc: '일본 묘코 롯데 아라이. 대회 고정 코스, 1278m에서 309m 강하.',
  },
};
